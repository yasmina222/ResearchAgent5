"""
Protocol Education CI System - Premium Processor (FIXED)
Integrates the premium AI engine with existing Streamlit app
Fixed: Removed duplicate financial data enhancement call
"""
...
class PremiumSchoolProcessor:
    ...
    def process_single_school(self, school_name: str, 
        ...
        # FIXED: Only call enhance_school_with_financial_data ONCE
        try:
    ...
    def _convert_to_intelligence(self, research_result: Dict[str, Any], 
        ...
        # REMOVED: Duplicate call to enhance_school_with_financial_data
        # This is now only called once in process_single_school
